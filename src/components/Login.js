                  ...
                  <div className="px-3">
                    <div className="auth-logo-box">
                      <Link to="/" className="logo logo-admin">
                        <img
                          src="./assets/images/logo_codeo.png"
                          height={55}
                          alt="logo"
                          className="auth-logo"
                        />
                    ...
                    >
                      <div className="form-group">
                        ...
                        <div className="input-group mb-3">
                          ...
                          <input
                            type="text"
                            name="email"
                            className={classnames("form-control frm-new", {
                        ...
                        {errors.email && (
                          <div
                            className="invalid-feedback pesanerror"
                      ...
                      <div className="form-group">
                        ...
                        {errors.password && (
                          <div className="invalid-feedback pesanerror">
                            {errors.password}
                          </div>
                        )}
                      </div>
                      ...
                      <div className="form-group  mb-0 row mt-4">
                        <div className="col-sm-6 text-left">
                          <Link to="/register" className="text-muted font-13">
                            <i className="dripicons-lock" /> Register Here
                          </Link>
                        </div>
                        <div className="col-sm-6 text-right">
                          <Link to="/recover" className="text-muted font-13">
                      ...
                      <div className="form-group mb-0 row mt-3">
                        <div className="col-12 mt-2" align="center">
                          <button
                            ...
                            style={{ width: "100%" }}
                          >
                            Login <i className="fas fa-sign-in-alt ml-1" />
                          </button>
                        </div>
                        {/*end col*/}
                      </div>{" "}
                      {/*end form-group*/} {/*end form*/}
                    </form>
                  </div>
                </div>
                {/*end /div*/}
