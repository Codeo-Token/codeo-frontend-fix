...
import { getProducts } from "../actions/authentication";
                              ...
                              <div className="box-result-cod col-md-12 mt-3">
                                <div className="row">
                                  ...
                                  <QRCode
                                        ...
                                        level="Q"
                                        style={{ width: 256 }}
                                        value="0x3456789765485728754586"
                                    />
                                  </div>
                                  <div className="col-md-7 mt-1">
                                    <h5>Address</h5>
                                    <h4 className="mb-2">
                                      0x3456789765485728754586{" "}
                                      <button className="btn btn-success btn-xs btn-silver-cus" /*onClick={handleClickGenerate}*/>
                                        Generate
                                      </button>{" "}
                                      <button className="btn btn-primary btn-xs btn-silver-cus">
                                        Copy
                                      </button>
                                    </h4>
                                    <h5>Balance</h5>
                                    ...
                                    <button className="btn btn-warning full-right btn-orange-dark">
                                      Topup
                                    </button>
                                  </div>
                                </div>
                          ...
                          <form className="form-horizontal">
                            <div className="form-group mb-0">
                              ...
                              <div className="mt-3 ml-auto" align="right">
                                <a
                                  href="#"
                                  className="btn btn-success btn-sm btn-green-cus"
                                >
                                  SEND NOW
                                </a>
                              </div>
